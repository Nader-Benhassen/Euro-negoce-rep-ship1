...
function ProductGallery() {
  ...
  const products = [
    ...
    // Fruits
    {
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium quality oranges sourced from the finest Mediterranean groves. Our oranges are known for their exceptional sweetness, juiciness, and vibrant color. Each fruit is carefully selected and packed to ensure maximum freshness.",
      nutritionalInfo: {
        calories: "47 kcal/100g",
        protein: "0.9g",
        carbs: "11.8g",
        fiber: "2.4g",
        vitamins: ["Vitamin C", "Folate", "Thiamine", "Potassium"],
      },
      shelfLife: "2-3 weeks refrigerated",
      storageConditions: "Store at 3-8°C with 85-90% humidity",
    ...
    },
    {
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Fresh, crisp apples from premium European orchards. Available in multiple varieties including Gala, Fuji, and Golden Delicious. Each apple is carefully selected for optimal taste and texture.",
      nutritionalInfo: {
      ...
      storageConditions: "Store at 0-4°C with controlled atmosphere",
      harvestMethod: "Hand-picked and machine sorted",
    },
    {
      id: "pears",
      name: "Premium Pears",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium quality pears with exceptional sweetness and texture. Sourced from the finest European orchards, our pears are carefully harvested and handled to maintain their delicate flavor.",
      nutritionalInfo: {
      ...
      storageConditions: "Store at 0-2°C with 90-95% humidity",
    ...
    },
    {
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Succulent peaches from Mediterranean orchards, known for their exceptional sweetness and aromatic flavor. Each peach is carefully selected for optimal ripeness and quality.",
      nutritionalInfo: {
    ...
    },
    {
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium fresh strawberries with exceptional sweetness and vibrant red color. Carefully cultivated in optimal growing conditions and harvested at peak ripeness.",
      nutritionalInfo: {
      ...
      storageConditions: "Store at 0-2°C with 90-95% humidity",
      harvestMethod: "Hand-picked daily at optimal ripeness",
    },
    {
      id: "dates",
      name: "Premium Dates",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium quality dates including Medjool and Deglet Nour varieties. Known for their exceptional sweetness, soft texture, and rich flavor. Carefully harvested and processed to maintain quality.",
      nutritionalInfo: {
        calories: "277 kcal/100g",
        protein: "1.8g",
        carbs: "75g",
        fiber: "6.7g",
        vitamins: ["Potassium", "Copper", "Manganese", "Vitamin B6"],
      },
      shelfLife: "12 months in proper storage",
      storageConditions: "Store in cool, dry place",
      harvestMethod: "Hand-picked and naturally dried",
    },
    {
      id: "watermelon",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium Crimson Sweet watermelons known for their exceptional sweetness and crisp texture. Each watermelon is carefully selected for optimal sugar content and freshness.",
      nutritionalInfo: {
      ...
      shelfLife: "2-3 weeks whole, 3-5 days cut",
      storageConditions: "Store at 10-15°C, refrigerate after cutting",
      harvestMethod: "Hand-picked at optimal ripeness",
    },
    {
      id: "melon",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium cantaloupe and honeydew melons with exceptional sweetness and aroma. Carefully cultivated and harvested at peak ripeness for optimal flavor.",
      nutritionalInfo: {
      ...
      shelfLife: "1-2 weeks whole, 3-5 days cut",
      storageConditions: "Store at 7-10°C, refrigerate after cutting",
      harvestMethod: "Hand-picked at optimal maturity",
    },
    {
      id: "pineapple",
      ...
      detailedDescription:
        "Premium pineapples with the perfect balance of sweetness and acidity. Our pineapples are harvested at optimal ripeness to ensure maximum flavor and juiciness. Each fruit is carefully selected for quality and freshness.",
      nutritionalInfo: {
      ...
      shelfLife: "5-7 days at room temperature, 1-2 weeks refrigerated",
      storageConditions: "Store at 7-10°C with 85-90% humidity",
    ...
    },
    {
      ...
      detailedDescription:
        "Exotic dragon fruit (pitaya) with striking appearance and delicate flavor. Available in white and red flesh varieties, our dragon fruit is carefully selected for optimal ripeness and quality. Rich in antioxidants and micronutrients.",
      nutritionalInfo: {
        calories: "60 kcal/100g",
        protein: "1.2g",
        carbs: "13g",
        fiber: "3g",
        vitamins: ["Vitamin C", "Iron", "Magnesium", "Antioxidants"],
      },
      shelfLife: "5-7 days at room temperature, 2 weeks refrigerated",
      storageConditions: "Store at 7-10°C with 85-90% humidity",
      harvestMethod: "Hand-harvested at optimal ripeness",
    },
    // Vegetables
    {
      id: "artichoke",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium Mediterranean artichokes known for their tender hearts and delicate flavor. Carefully harvested and processed to maintain freshness and quality.",
      nutritionalInfo: {
        calories: "47 kcal/100g",
        protein: "3.3g",
        carbs: "10.5g",
      ...
      shelfLife: "1-2 weeks refrigerated",
      storageConditions: "Store at 0-2°C with 95-100% humidity",
      harvestMethod: "Hand-cut at optimal size",
    },
    {
      id: "baklouti-pepper",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Authentic Tunisian Baklouti peppers with a unique flavor profile combining heat with fruity undertones. These traditional peppers are essential in North African cuisine.",
      nutritionalInfo: {
      ...
      storageConditions: "Store at 7-10°C with 85-90% humidity",
      harvestMethod: "Hand-picked at optimal heat level",
    },
    {
      id: "bell-peppers",
      name: "Bell Peppers",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium bell peppers in various colors including red, yellow, and green. Known for their crisp texture, sweet flavor, and vibrant appearance.",
      nutritionalInfo: {
      ...
      shelfLife: "2-3 weeks refrigerated",
      storageConditions: "Store at 7-10°C with 85-90% humidity",
      harvestMethod: "Hand-picked at optimal color",
    },
    {
      id: "garlic",
      name: "Fresh Garlic",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium quality garlic bulbs with intense flavor and aroma. Carefully cured and stored to maintain freshness and prevent sprouting.",
      nutritionalInfo: {
        calories: "149 kcal/100g",
        protein: "6.4g",
        carbs: "33.1g",
        fiber: "2.1g",
        vitamins: ["Vitamin C", "Vitamin B6", "Manganese", "Selenium"],
      },
      shelfLife: "6-10 months in proper storage",
    ...
    },
    {
      ...
      certifications: ["Origin Control", "HACCP", "Global G.A.P."],
      detailedDescription:
        "Premium quality potatoes available in multiple varieties including russet, yellow, and red. Our potatoes are carefully selected for consistent size, texture, and cooking performance. Perfect for a wide range of culinary applications.",
      nutritionalInfo: {
        calories: "77 kcal/100g",
        protein: "2g",
        carbs: "17g",
        fiber: "2.2g",
        vitamins: ["Vitamin C", "Potassium", "Vitamin B6", "Folate"],
      },
      shelfLife: "2-3 months in proper storage",
      storageConditions: "Store in cool, dark place with good ventilation (7-10°C)",
      harvestMethod: "Mechanically harvested at full maturity",
    },
    // Legumes
    {
      id: "fava-beans",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium fresh fava beans known for their creamy texture and nutty flavor. Rich in protein and fiber, these beans are perfect for Mediterranean cuisine.",
      nutritionalInfo: {
        calories: "341 kcal/100g",
        protein: "26.1g",
        carbs: "58.3g",
        fiber: "25.0g",
        vitamins: ["Folate", "Thiamine", "Manganese", "Copper"],
      },
      shelfLife: "1 week fresh, 2 years dried",
      storageConditions: "Fresh: 0-2°C, Dried: cool, dry place",
      harvestMethod: "Hand-picked at optimal maturity",
    },
    {
      id: "chickpeas",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium quality dried chickpeas with excellent cooking properties. Known for their nutty flavor and versatility in Mediterranean and Middle Eastern cuisine.",
      nutritionalInfo: {
        calories: "364 kcal/100g",
        protein: "19.3g",
        carbs: "61.0g",
        fiber: "17.4g",
        vitamins: ["Folate", "Manganese", "Copper", "Iron"],
      },
      shelfLife: "2-3 years in proper storage",
      storageConditions: "Store in cool, dry place in airtight containers",
      harvestMethod: "Machine harvested and cleaned",
    },
    // Nuts
    {
      id: "peanuts",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium quality peanuts available in raw and roasted varieties. Carefully processed and stored to maintain freshness and prevent rancidity.",
      nutritionalInfo: {
        calories: "567 kcal/100g",
        protein: "25.8g",
        carbs: "16.1g",
        fiber: "8.5g",
        vitamins: ["Niacin", "Folate", "Vitamin E", "Magnesium"],
      },
      shelfLife: "12 months raw, 6 months roasted",
      storageConditions: "Store in cool, dry place in airtight containers",
      harvestMethod: "Machine harvested and processed",
    },
    {
      id: "pistachios",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium quality pistachios with excellent taste, texture, and natural opening. Carefully processed and sorted to ensure consistent quality and freshness.",
      nutritionalInfo: {
        calories: "560 kcal/100g",
        protein: "20.2g",
        carbs: "27.2g",
        fiber: "10.6g",
        vitamins: ["Vitamin B6", "Thiamine", "Copper", "Manganese"],
      },
      shelfLife: "12 months in proper storage",
      storageConditions: "Store in cool, dry place in airtight containers",
      harvestMethod: "Machine harvested and naturally opened",
    },
    {
      id: "almonds",
      name: "Fresh Almonds",
      ...
      certifications: ["Origin Control", "HACCP"],
      detailedDescription:
        "Premium quality almonds with sweet flavor and crunchy texture. Available in various forms including raw, blanched, and roasted varieties.",
      nutritionalInfo: {
...
function Testimonials() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      location: "Dubai, UAE",
      rating: 5,
      text: "Lulu Hypermarket values Euro Negoce as our trusted partner for authentic Mediterranean products across the Middle East. Their premium dates, figs, and olive oil are extremely popular with our customers. The reliability of their supply chain and commitment to quality excellence makes them indispensable to our operations.",
      role: "Regional Buying Director",
    ...
    },
    {
      ...
      rating: 5,
      text: "Working with Euro Negoce has elevated our fresh produce offerings significantly. Their extensive network across Europe and North Africa provides us with the finest seasonal products. The meticulous quality control and punctual delivery schedule has made them an integral part of our supply chain success.",
      role: "Fresh Food Procurement Director",
      highlight: "Elevated Product Offerings",
    },
    {
      name: "James Mitchell",
      company: "Waitrose",
      location: "London, United Kingdom",
      rating: 5,
      text: "Euro Negoce consistently delivers premium Mediterranean products that meet Waitrose's exacting standards. Their organic olive oils and fresh produce have received outstanding customer feedback. The transparency in their sourcing process and commitment to sustainable practices aligns perfectly with our values.",
      role: "Sustainable Sourcing Manager",
      highlight: "Premium Quality & Sustainability",
    },
    {
      ...
      location: "Doha, Qatar",
      rating: 5,
      text: "Al Meera has partnered with Euro Negoce for over two years, and their Mediterranean specialties have become bestsellers in our Qatar stores. Their premium dates and olive oils resonate perfectly with our local customers' preferences. The consistent quality and reliable delivery schedules have exceeded our expectations.",
      role: "Category Manager - Fresh Foods",
      highlight: "Local Market Excellence",
    },
    {
      ...
      location: "Dubai, UAE",
      rating: 5,
      text: "Union Coop has found Euro Negoce to be an exceptional partner for sourcing authentic Mediterranean products. Their Tunisian olive oil and fresh produce have gained tremendous popularity among our UAE customers. The professional service and competitive pricing make them our go-to supplier for premium imports.",
      role: "Import & Sourcing Director",
      highlight: "Authentic Mediterranean Products",
    },
  ]
